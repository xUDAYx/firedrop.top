...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    ...
    <li className="list-none p-0">
      <article className="md:max-w-[350px] lg:max-w-[270px] max-w-[350px] overflow-hidden shadow-xl bg-[#2a2e35] hover:scale-105 rounded-xl transition-transform ease-in-out duration-500 relative">
