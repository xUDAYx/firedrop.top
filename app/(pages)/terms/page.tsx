    ...
    <PageWrapper>
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            We provide professional academic project development services through WhatsApp consultation and support.
          </p>
          
          <h2>Communication</h2>
          <p>
            Primary communication is conducted through WhatsApp for efficient and timely responses.
          </p>
